...
let ext;
  if (media.mimetype === 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet') {
    ...
    ext = 'dotx';
  } else if (media.mimetype === 'application/vnd.openxmlformats-officedocument.presentationml.template'){
    ext = 'potx';
  } else if (media.mimetype === 'application/vnd.openxmlformats-officedocument.presentationml.slideshow'){
    ext = 'pps';
  } else if (media.mimetype === 'application/vnd.openxmlformats-officedocument.presentationml.slideshow'){
    ext = 'ppsx';
